        ...
        messages: [
          {
            role: "system",
            content:
              "You generate brief summaries of what a developer is working on based on their project context. Respond with exactly 1 short sentence. Just describe the activity, no role labels like 'Worker' or 'Developer'. Example: 'Building auth in the Kismet project'",
          },
          {
            role: "user",
